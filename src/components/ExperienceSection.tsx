...
const experiences = [
  {
    role: "Visual Animator",
    company: "MicroNex PAK",
    type: "Internship",
    period: "Mar 2026 - Present",
    location: "Sindh, Pakistan",
    desc: "Motion sequencing, pacing, kinetic typography, and visual animation for brand content.",
  },
  {
    role: "AI Artist",
    company: "RedverseAI",
    ...
    location: "Remote",
    desc: "Created ultra-realistic digital images and videos for product launches using generative AI, prompt engineering, and tools like Google Veo & CapCut Pro.",
  },
  {
    role: "Graphic Designer",
    company: "She's Beyond (Non-Profit)",
    type: "Volunteer",
    period: "Jun 2025 - Dec 2025",
    location: "Remote",
    desc: "Media team member creating visually compelling content, event banners, social media posts, and promotional materials for women empowerment campaigns.",
  },
  {
    ...
    desc: "Produced engaging reels and video content supporting the social media marketing team, enhancing brand visibility and audience engagement.",
  },
  {
    role: "Director — IEEE (DSB)",
    company: "DAWOOD UET",
    type: "Full-time",
    period: "Jan 2022 - Dec 2024",
    location: "Sindh, Pakistan",
    desc: "Led information mediation, marketing, graphic design, video editing, and event management. Hosted IEEE events and volunteered in university orientations.",
  },
  {
    role: "Social Media & Project Manager",
    company: "Quick Byte Innovation",
    type: "Part-time",
    period: "Jan 2024 - May 2024",
    location: "Karachi, Pakistan",
    desc: "Managed social media strategy and project coordination for the organization.",
  },
];
...
const education = [
  {
    ...
    grade: "Grade: A",
    desc: "Specializing in AI & Cybersecurity. Active in IEEE, volunteering, event hosting, and recognized by VC Dr. Samreen.",
  },
  {
    degree: "SOC Analyst Course",
    school: "NED University of Engineering & Technology",
    period: "Aug 2023 – Oct 2023",
    desc: "Mastered cybersecurity fundamentals, SIEM tools, incident response, threat intelligence, and vulnerability assessment.",
  },
];
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-20">
          ...
          <div>
            ...
            <div className="space-y-4">
              {experiences.map((exp, i) => (
                <div key={i} className="glass-card-3d p-5 relative">
          ...
          <div>
            ...
            <div className="space-y-4 mb-8">
              {education.map((edu, i) => (
                <div key={i} className="glass-card-3d p-5">
